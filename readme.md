...
// 2o parâmetro fetch('/data.json',<METHOD>). Por default o METHOD é GET, mas tmbém poder ser usado POST, DELETE, UPDATE, etc.
```
...
emitter.emit('User logged', { user: 'Wellysson' });
...
// execute
// server node node-script.js
// EventTarget poderá ser também utilizado.
```
...
- Tipos de console
  ...
  - console.table(['Wellysson', 'Digital Innovation One']): Formata os dados em tabela
